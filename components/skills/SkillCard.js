...
const SkillCard = ({ name, url, index }) => {
  ...
  return (
    <motion.h3
      ...
      exit="exit"
      initial="initial"
      className="flex flex-row items-center rounded-[4px] justify-start w-full py-2 mb-3 text-lg md:text-xl text-left px-4 bg-darkBluePrimary text-lightBluePrimary"
    >
